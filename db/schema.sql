...
--
-- Name: terms_pmcs(character varying[]); Type: FUNCTION; Schema: app_public; Owner: -
--

CREATE FUNCTION app_public.terms_pmcs(pmcids character varying[]) RETURNS TABLE(pmc character varying, term character varying, id uuid)
    LANGUAGE sql IMMUTABLE STRICT PARALLEL SAFE
    AS $$
