  ...
  return (
    <div className="flex flex-col gap-2 my-2">
      <h2 className="text-md font-bold">
        After rummaging through <Stats show_gene_sets />. Rummagene <img className="inline-block rounded" src="/images/rummagene_logo.jpg" width={50} height={100} alt="Rummagene"></img> found your search term in the table titles of {data.geneSetTermSearch?.totalCount} gene sets.
      </h2>
